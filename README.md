...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/filament-stripe.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/filament-stripe)
...
```php
$filamentStripe = new A21ns1g4ts\FilamentStripe();
echo $filamentStripe->echoPhrase('Hello, A21ns1g4ts!');
```
